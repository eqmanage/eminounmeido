document.addEventListener('DOMContentLoaded', () => {
  ...
  const allJobCategories = ['エンジニア・IT', '経理・総務・人事', '営業', '販売・接客', '運送・配達・タクシー', '工場勤務・製造', '飲食店勤務', '土木・建設', '医療・介護', '公務員', '保育士', '教師', '主婦・主夫', '美容師'];
